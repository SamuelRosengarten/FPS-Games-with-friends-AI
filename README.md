...
- **High-end graphics** (Ultra preset for M-series Pro/Max and RTX GPUs): 4K shadow maps, ambient occlusion (GTAO), bloom,
  ...
  grass swaying in the wind, waving flags, a fountain, rooftop clutter, wires, graffiti, puddles…), detailed weapon models
  with wood grain, brushed/scratched metal and stippled polymer, gloved hands with real fingers, shell casings, blood
