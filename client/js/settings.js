...
export const ACTIONS = [
  ...
  ['leanL', 'Lean left'], ['leanR', 'Lean right'], ['drop', 'Drop weapon'], ['inspect', 'Inspect weapon'], ['flashlight', 'Flashlight (night)'],
...
export const DEFAULTS = {
  ...
  keys: {
    ...
    leanL: ['KeyQ'], leanR: ['KeyE'], drop: ['KeyG'], inspect: ['KeyV'], flashlight: ['KeyT'],
